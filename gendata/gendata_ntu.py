...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../data/raw_data/nturgbd_raw/nturgb+d_skeletons/')
    parser.add_argument('--ignored_sample_path',
                        default='../data/raw_data/nturgbd_raw/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/processed_data/ntu/')
