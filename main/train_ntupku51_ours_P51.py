...
class Processor():
    ...
    def apply_W_resample(self, data_src, resample_tag):
        ...
        elif resample_tag=='cropresize':
            return f_cropresize_torch_batch(data_src, [0.5,1.0])
       
        elif resample_tag=='cropresize0.5':
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data_src, label, index) in enumerate(process):
            ...
            # add another resample before recover and resample.
            data_src = self.apply_W_resample(data_src, "cropresize")
