...
class Processor():
    ...
    def __init__(self, arg):
        ...
        self.temporal_jigsaw = TemporalJigsaw(self.arg.n_jigsaw)
        self.num_label_jigsaw = self.temporal_jigsaw.jig_num
        # add jigsaw
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data_src, label, index) in enumerate(process):
            ...
            data_jigsaw, label_jig = self.temporal_jigsaw.gen_data(data_src)
